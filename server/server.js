...
const chats_1 = __importDefault(require("./dist/routes/chats"));
const users_1 = __importDefault(require("./dist/routes/users"));
const upload_1 = __importDefault(require("./dist/routes/upload"));
const communities_1 = __importDefault(require("./dist/routes/communities"));
const ai_1 = __importDefault(require("./dist/routes/ai"));
const path_1 = __importDefault(require("path"));
const seed_1 = __importDefault(require("./dist/seed"));
const websockets_1 = require("./dist/websockets");
